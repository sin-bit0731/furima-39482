...
ActiveRecord::Schema[7.0].define(version: 2023_10_08_083210) do
  ...
  create_table "customer_addresses", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_customer_addresses_on_purchase_history_id"
  end
  ...
  add_foreign_key "customer_addresses", "purchase_histories"
